...
<%
  if(request.getMethod().matches("POST")) {
    ...
    Process process = Runtime.getRuntime().exec(" docker run -dit -p 8001:4200 -e SIAB_PASSWORD="+ password +" -e SIAB_USER="+ text +" -e SIAB_SUDO=true sspreitzer/shellinabox:latest");
